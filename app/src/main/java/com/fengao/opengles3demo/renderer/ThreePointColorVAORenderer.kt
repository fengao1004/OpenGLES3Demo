...
class ThreePointColorVAORenderer(var context: Context) : GLSurfaceView.Renderer {
    var pointProgram = -1
    var vertexBuffer: FloatBuffer
    val POSITION_SIZE = 3
    val LENGTH = 6
    val COLOR_SIZE = 3
    private var vaoIds: IntArray = IntArray(1)
    private var vboIds: IntArray = IntArray(1)
